...
function App() {
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen bg-background overflow-hidden">

      {/* LEFT PANE - Hero & 3D Brain */}
      <div className="relative w-full lg:w-[55%] h-[50vh] lg:h-screen flex flex-col items-center justify-center border-r border-border bg-black">
        ...
        {/* Dark overlay behind text to ensure perfect readability */}
